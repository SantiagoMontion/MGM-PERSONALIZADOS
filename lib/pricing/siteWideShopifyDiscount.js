/** Promo 20% OFF en Shopify (precio de venta) + lista como compare-at. Alfombra excluida. */
 ...
 * - Alfombra / promo off: price = lista, sin compare-at
...
export function resolveShopifySalePricing({ listPrice, material } = {}) {
  ...
  if (!SITE_WIDE_SHOPIFY_DISCOUNT_ENABLED || isAlfombraMaterialLabel(material)) {
