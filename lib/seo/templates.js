...
export function renderSeoDocument({
  ...
  const ogImageAltText = escapeHtml(ogImageAlt || 'Mousepad gamer personalizado NOTMID');
...
<meta name="twitter:creator" content="@notmid" />
<style>${BASE_STYLE}</style>
${renderJsonLdScripts(jsonLd)}
</head>
<body>
${bodyHtml}
<footer class="page-footer">${escapeHtml('© ' + new Date().getFullYear() + ' NOTMID — Mousepads personalizados en Argentina.')}</footer>
</body>
</html>`;
}
