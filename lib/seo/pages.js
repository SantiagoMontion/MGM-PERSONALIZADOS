...
export function renderHomePage() {
  ...
  const sections = [
    {
      ...
      paragraphs: [
        'Un mousepad gamer personalizado eleva tu setup competitivo con una superficie optimizada para eSports y un diseño único. En NOTMID imprimimos en alta definición sobre materiales profesionales para que cada movimiento sea preciso.',
  ...
  const html = renderSeoDocument({
    title: 'Mousepad Gamer Personalizado - Diseñá el Tuyo | NOTMID',
    description:
      'Creá mousepads gamers personalizados o Glasspads en NOTMID. Alta calidad, ideales para esports, con envío rápido en Argentina.',
    canonical,
    keywords,
...
export function renderEditorPage() {
  ...
  return renderSeoDocument({
    title: 'Diseñá tu Mousepad Gamer Personalizado | NOTMID',
    description:
    ...
    keywords,
    ogImage: buildDefaultImageUrl(),
    ogImageAlt: 'Editor de mousepads personalizados NOTMID',
    jsonLd: [buildOrganizationJsonLd()],
    bodyHtml,
  });
}
...
export function renderCheckoutPage() {
  ...
  return renderSeoDocument({
    title: 'Finalizá tu Compra de Mousepads Personalizados | NOTMID',
    description:
    ...
    keywords,
    ogImage: buildDefaultImageUrl(),
    ogImageAlt: 'Checkout de mousepads personalizados NOTMID',
    jsonLd: [buildOrganizationJsonLd()],
    bodyHtml,
  });
}
...
export async function renderProductPage(jobId) {
  ...
  const html = renderSeoDocument({
    title: `${productName} | NOTMID Argentina`,
    description,
    canonical,
    keywords,
    ogImage,
...
function renderMissingProduct(jobId) {
  ...
  const bodyHtml = renderPageLayout({ hero, sections });
  const html = renderSeoDocument({
    title: 'Mousepad personalizado no disponible | NOTMID',
    description: 'El mousepad gamer personalizado que buscás no está disponible. Diseñá uno nuevo con NOTMID en Argentina.',
    canonical,
    keywords,
    ogImage: buildDefaultImageUrl(),
