...
/**
 * PDFs viven en bucket outputs: pdf/YYYY/MM/archivo.pdf
 * Previews (savePrintPreviewToSupabase) en el mismo bucket: preview/YYYY/MM/archivo.jpg
 * Formato viejo: pdf-… en path → mockups-… .png
 */
