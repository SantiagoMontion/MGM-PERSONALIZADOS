...
function resolveMaterialLabelFromProductType(productTypeRaw) {
  const normalized = String(productTypeRaw || '').trim().toLowerCase();
...
export async function publishProduct(req, res) {
  ...
  try {
    ...
    const materialLabel = resolveMaterialLabelFromProductType(productTypeRaw);
