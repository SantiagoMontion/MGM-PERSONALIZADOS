...
export async function publishProduct(req, res) {
  ...
  try {
    ...
    const requestedPriceTransfer = toNumber(body.price ?? body.priceTransfer);
    ...
    let priceTransfer = calculatorTransferPrice;
    let priceTransferSource = 'calculator';
