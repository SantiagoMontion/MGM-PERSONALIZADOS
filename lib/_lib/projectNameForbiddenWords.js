...
/**
 * Normaliza para comparar: minúsculas, sin acentos y sin separadores/símbolos.
 * Así no se saltea con MAYÚS, "M.o.u.s.e", "pro-", etc.
 * @param {string} value
 */
 ...
 * sin importar mayúsculas, acentos o separadores.
 * @param {string} value
 */
